...
// options specified by gso.
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        findGameButton = (Button) v.findViewById(R.id.find_game_button);

        mStatusTextView = (TextView) v.findViewById(R.id.status);
        //Bitmap icon = BitmapFactory.decodeResource(getContext().getResources(),R.drawable.whogotnex);
        ...
        findGameButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent findGame = new Intent(getActivity(), viewMaps.class);
                startActivity(findGame);
            }
        });
        return v;
    }
    ...
    private void updateUI(boolean signedIn) {
        if (signedIn) {
            ...
            //I can sign out from this activity by
            //adding a sign out button in viewMaps

            findGameButton.setVisibility(View.VISIBLE);
        ...
        else
        {
            ...
            findGameButton.setVisibility(View.GONE);
        }
    }
